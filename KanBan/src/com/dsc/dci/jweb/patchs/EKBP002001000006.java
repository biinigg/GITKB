...
import com.dsc.dci.sqlcode.patchs.sqlEKBP002001000006;

/*
 * 1.調整(縮短)部分常態錯誤訊息輸出
 * 2.調整patch執行輸出方式
 * 3.設定資料庫連線測試timeout時間為3秒
 * 4.工具列能否增加上一筆、下一筆
 * 5.新增後儲存，畫面會清空，應留在新增的這筆，以便於編輯單身
*/
public class EKBP002001000006 {
	private sqlEKBP002001000006 cmd;
	private DatabaseObjects dbobj;
	private DBControl dbctrl;

	public EKBP002001000006(boolean execPatch) {
		this.dbobj = DatabaseObjects.getInstance();
		this.cmd = new sqlEKBP002001000006();
