...
import com.dsc.dci.sqlcode.patchs.sqlEKBP002001000004;

public class EKBP002001000004 {

	private sqlEKBP002001000004 cmd;
	private DatabaseObjects dbobj;
	private DBControl dbctrl;

	public EKBP002001000004(boolean execPatch) {
		this.dbobj = DatabaseObjects.getInstance();
		this.cmd = new sqlEKBP002001000004();
